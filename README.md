...
export SAKURA_API_ACCESS_SECRET=XXXXXXXXXXXXXX
...
```
環境変数 `SAKURA_API_ACCESS_TOKEN`と`SAKURA_API_ACCESS_SECRET`は, [さくらのオブジェクトストレージ APIドキュメント-基本的な使い方-APIキーの発行](https://manual.sakura.ad.jp/api/cloud/objectstorage/#section/%E5%9F%BA%E6%9C%AC%E7%9A%84%E3%81%AA%E4%BD%BF%E3%81%84%E6%96%B9/API) を参考に入手します.
...
env = { SAKURA_API_ACCESS_TOKEN = "01234567-89ab-cdef-0123-456789abcdef", SAKURA_API_ACCESS_SECRET = "XXXXXXXXXXXXXX" }
check_interval = 60
timeout_seconds = 60
